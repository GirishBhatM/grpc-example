...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.example.grpc.service.Book.Builder subBuilder = null;
            if (book_ != null) {
              subBuilder = book_.toBuilder();
            }
            book_ = input.readMessage(com.example.grpc.service.Book.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.example.grpc.service.BookResponse)) {
      return super.equals(obj);
    }
    com.example.grpc.service.BookResponse other = (com.example.grpc.service.BookResponse) obj;
  ...
  public static com.example.grpc.service.BookResponse parseFrom(
  ...
  public static com.example.grpc.service.BookResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.example.grpc.service.BookResponse parseFrom(
  ...
  public static com.example.grpc.service.BookResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.example.grpc.service.BookResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.example.grpc.service.BookResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.example.grpc.service.BookResponse prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.example.grpc.service.BookResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.example.grpc.service.BookResponse getDefaultInstanceForType() {
      return com.example.grpc.service.BookResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.example.grpc.service.BookResponse build() {
      com.example.grpc.service.BookResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.example.grpc.service.BookResponse buildPartial() {
      com.example.grpc.service.BookResponse result = new com.example.grpc.service.BookResponse(this);
      result.id_ = id_;
      if (bookBuilder_ == null) {
        result.book_ = book_;
      } else {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.example.grpc.service.BookResponse) {
        return mergeFrom((com.example.grpc.service.BookResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.example.grpc.service.BookResponse other) {
      if (other == com.example.grpc.service.BookResponse.getDefaultInstance()) return this;
      if (other.getId() != 0) {
        setId(other.getId());
      }
      if (other.hasBook()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.example.grpc.service.BookResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.example.grpc.service.BookResponse) e.getUnfinishedMessage();
    ...
    public Builder mergeBook(com.example.grpc.service.Book value) {
      if (bookBuilder_ == null) {
        if (book_ != null) {
          book_ =
            com.example.grpc.service.Book.newBuilder(book_).mergeFrom(value).buildPartial();
        } else {
          book_ = value;
        }
        onChanged();
    ...
    public com.example.grpc.service.BookOrBuilder getBookOrBuilder() {
      if (bookBuilder_ != null) {
        ...
        return book_ == null ?
            com.example.grpc.service.Book.getDefaultInstance() : book_;
      }
    }
    /**
     * <code>.com.example.grpc.service.Book book = 2;</code>
  ...
  public static com.example.grpc.service.BookResponse getDefaultInstance() {
